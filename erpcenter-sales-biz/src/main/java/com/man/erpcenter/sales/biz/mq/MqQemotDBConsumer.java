...
public class MqQemotDBConsumer  extends BaseRocketMqConsumer{
	...
	public String getTopic() {
		return MqMsgInfoEnum.ADD_EMOT_DB.topic;
	}

	@Override
	public String getTags() {
		return MqMsgInfoEnum.ADD_EMOT_DB.tags;
	}
	...
	public boolean doConsumeMessage(Serializable message) {
		...
		if(null != message && message instanceof QemotInfoMqVo){
			 ...
			 try{
				// qqInfoManager.insertEmotIntoDB(qemotInfoMqVo);
				 qqInfoManager.insertEmotIntoDBBatch(qemotInfoMqVo);
			 }catch(Exception e){
				 e.printStackTrace();
			 }
		}
